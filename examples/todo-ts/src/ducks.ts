import { combineReducers, Thunk } from "reslice";
...
type Slice = Thunk<typeof reducers>;
 ...
 **/
export const reducer = combineReducers(reducers, { actions });
